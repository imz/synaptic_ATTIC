...
BuildRequires: XFree86-devel XFree86-libs docbook-dtds docbook-style-xsl fontconfig freetype2 gcc-c++ glib2-devel intltool libapt-devel libart_lgpl-devel libatk-devel libglade2-devel libgtk+2-devel libpango-devel libpopt-devel librpm-devel libstdc++-devel libxml2-devel libzvt-devel perl-XML-Parser pkgconfig scrollkeeper xml-common xsltproc
