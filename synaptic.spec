...
BuildRequires: XFree86-devel XFree86-libs docbook-dtds docbook-style-xsl fontconfig freetype2 gcc-c++ glib2-devel libapt-devel libart_lgpl-devel libatk-devel libdb4.0-devel libexpat libglade2-devel libgtk+2-devel libpango-devel libpopt-devel librpm-devel libstdc++-devel libxml2-devel libxslt libzvt-devel pkgconfig scrollkeeper xml-common xsltproc zlib-devel
